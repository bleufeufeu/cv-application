  ...
  const practicalInfoHandler = (event, id) => {
    ...
    setPracticalInfo((prevPracticalInfo) =>
      prevPracticalInfo.map((practical) =>
        practical.id === id ? { ...practical, [name]: value } : practical,
      ),
    );
  };
    ...
    <>
      <form>
        <GeneralForm
          ...
          changeHandler={generalInfoHandler}
        />
        <PracticalForm
          practicalInfo={practicalInfo}
          changeHandler={practicalInfoHandler}
          addButton={addPracticalInfo}
          deleteButton={deletePracticalInfo}
        />
        <EducationForm
          educationInfo={educationInfo}
          changeHandler={educationInfoHandler}
          addButton={addEducationInfo}
          deleteButton={deleteEducationInfo}
        />
      </form>
