...
export default function EducationForm({ educationInfo, changeHandler, addButton, deleteButton }) {
    return (
        <section className="educationForm">
                ...
                {educationInfo.map((education) => {
                    return (
                        <div className="educationItem" key={education.id}>
                            <button className="delete" type="button" onClick={() => deleteButton(education.id)}><FaRegTrashCan /></button>
            ...
            <button className="addButton" type="button" onClick={addButton}><FaPlus /> Add School</button>
        </section>
    );
}