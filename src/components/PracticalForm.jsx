...
export default function PracticalForm({ practicalInfo, changeHandler, addButton, deleteButton }) {
    return (
        <section className="practicalForm">
                ...
                {practicalInfo.map((practical) => {
                    return (
                        <div className="practicalItem" key={practical.id}>
                            <button className="delete" type="button" onClick={() => deleteButton(practical.id)}><FaRegTrashCan /></button>
            ...
            <button className="addButton" type="button" onClick={addButton}><FaPlus /> Add Job</button>
        </section>
    );
}