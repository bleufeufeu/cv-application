    import { FaEnvelope, FaPhone, FaLocationDot, FaArrowUpRightFromSquare } from "react-icons/fa6"
    
    export default function CVPreview({ generalInfo, practicalInfo, educationInfo}) {
        return (
            <div className="cvPage">
                <section className="cvGeneralSection">
                    ...
                    <div className="cvGeneralDetails">
                        {generalInfo.email !== "" && <p><FaEnvelope /> {generalInfo.email}</p>}
                        {generalInfo.phone !== "" && <p><FaPhone /> {generalInfo.phone}</p>}
                        {generalInfo.address !== "" && <p><FaLocationDot /> {generalInfo.address}</p>}
                        {generalInfo.website !== "" && <p><FaArrowUpRightFromSquare /> {generalInfo.website}</p>}
                    </div>
                </section>
